    ...
    public class FileGenerationProgressForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            closeButton = new Button
            {
                ...
                FlatAppearance = { BorderColor = Color.FromArgb(0, 100, 200), BorderSize = 1 },
            };
        ...
        private Image CreateDocumentIcon(int width, int height)
        {
            ...
            using (var g = Graphics.FromImage(bitmap))
            {
                ...
                // Fill the document
                using (
                    var docBrush = new LinearGradientBrush(
                        docRect,
                        Color.White,
                    ...
                    this.Invoke(
                        (MethodInvoker)
                            delegate
                            {
                                ...
                                statusLabel.Text =
                                    "Files generated successfully. Please restart the application.";
                                progressTimer.Stop();
                                pulseTimer.Stop();
